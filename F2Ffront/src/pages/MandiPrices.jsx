...
const MandiPriceFinder = () => {
  ...
  const handleSubmit = (values, { resetForm }) => {
    const results = mandiData.filter((item) => {
      const stateMatch = item.State.trim().toLowerCase() === values.state.trim().toLowerCase();
      const marketMatch = item.Market.trim().toLowerCase() === values.market.trim().toLowerCase();
      const commodityMatch = item.Commodity.trim().toLowerCase() === values.commodity.trim().toLowerCase();
      return stateMatch && marketMatch && commodityMatch;
    });
