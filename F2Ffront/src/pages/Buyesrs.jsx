...
import { User, Search, Clock2 } from 'lucide-react';
import CommodityModalBuy from './CommodityModel';
  ...
  useEffect(() => {
    const fetchCommodities = async () => {
      ...
      try {
        ...
        setError('Failed to fetch buyer commodities.');
          ...
          {filteredCommodities.map((item) => (
            ...
            >
              ...
              <div onClick={() => openModal(item)}
                className={`relative grid ${item.images.length === 1
                  ? 'grid-cols-1'
              ...
              <div div className="flex items-center px-4 py-2 bg-gray-50" >
                ...
                <div className="flex flex-col gap-2 items-center">
                  ...
                  <a href={`https://wa.me/${item.buyer.mobile}`} target="_blank" rel="noopener noreferrer" className="flex items-center w-[25px] h-[25px]">
