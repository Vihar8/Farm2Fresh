                ...
                <div className="border-t border-gray-200 pt-4 space-y-6">
                    ...
                    <div className="bg-gray-100 rounded-lg p-4 shadow-sm">
                        <div className="flex font-semibold gap-2 text-gray-800">
                            ...
                            <p className="text-xs text-gray-500">
                                <span className="inline-flex items-center px-1 py-1 bg-green-100 text-green-700 font-medium rounded-full border border-green-300 shadow-sm">
                                    {commodity.buyer.user_type || 'Buyer'}
                                </span>
                            </p>
                        </div>
                        <div className="flex items-center gap-2 pl-2 mt-2">
                            ...
                            <a
                                href={`tel:${commodity.buyer.mobile}`}
                        ...
                        <div className="flex items-center gap-2 pl-2">
                            <a href={`https://wa.me/${commodity.buyer.mobile}`} target="_blank" rel="noopener noreferrer" className="flex items-center w-[15px] h-[15px]">
                            ...
                            <a
                                href={`https://wa.me/${commodity.buyer.mobile}`}
                        ...
                        <div className="flex items-center gap-2 pl-2">
                            ...
                            <a
                                href={`mailto:${commodity.buyer.email}`}
