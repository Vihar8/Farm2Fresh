...
const SellerCommodities = () => {
  ...
  return (
    ...
    Share
            ...
            <div className="flex items-center px-4 py-5 bg-gray-50">
              ...
              <div className="flex flex-col gap-2 items-center">
                {/* Call Icon */}
                <a href={`tel:${item.seller.mobile}`} target="_blank" rel="noopener noreferrer" className="flex items-center">
                  <svg
                ...
                {/* WhatsApp Icon */}
                <a href={`https://wa.me/${item.seller.mobile}`} target="_blank" rel="noopener noreferrer" className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="#25d366"
